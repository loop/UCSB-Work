...
public class Heap<T extends Comparable<T>> {
    ...
    /*
     * makeHeap - turn the elements in the contents array into a representation
     * of a max-at-top heap.
     */
    ...
    /**
     * insert - add the specified item to the heap and sift it up into its
     * proper position.
     */
    ...
    /**
     * remove and return the item at the top of the heap, and adjust the
     * remaining items so that we still have a heap.
     */
    public T remove() {
    ...
    /*
     * siftDown - sift the element in contents[i] down into its correct position
     * in the heap.
     */
    ...
    /*
     * siftUp - sift the element in contents[i] up into its correct position in
     * the heap.
     */
